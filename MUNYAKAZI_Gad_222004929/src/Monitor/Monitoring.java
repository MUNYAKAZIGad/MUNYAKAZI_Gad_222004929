...
public class Monitoring implements ActionListener{ 
//fields of the form 
//frame 
    JFrame frame; 
//labels 
...
//buttons 
    JButton monitorButton = new JButton("Monitor Criminal"); 
...
//constructor 
   ...
   public void createWindow() {
          frame=new JFrame(); 
          frame.setTitle("Get Criminal Detected by System"); 
   ...
   public void setLocationAndSize() {
       //This is for JLabel we have inside our GUI Application
        ...
        // This is for the other button we have inside our GUI Application 
             monitorButton.setBounds(160, 570, 130, 30); 
             backButton.setBounds(320, 570, 100, 30);          
     }
               ...
               try
                 {
                    ...
                    // Not password is set on mysql
                    // Accept usernae and password
            
                    Statement stm = con.createStatement();
                    //mysql query to run
                    String sql = "select * from criminal_info";
                    ResultSet rs = stm.executeQuery(sql);
                 while (rs.next()) {
                   firstname0.setText(rs.getString("firstname"));
                   lastname0.setText(rs.getString("lastname"));
                   picture0.setText(rs.getString("picture"));
                   crime0.setText(rs.getString("crime"));
                   address0.setText(rs.getString("residential_address")); 
                   province0.setText(rs.getString("province")); 
                   district0.setText(rs.getString("district")); 
                   sector0.setText(rs.getString("sector")); 
                   village0.setText(rs.getString("village")); 
                   cell0.setText(rs.getString("cell"));
                   father0.setText(rs.getString("father_name")); 
                   mother0.setText(rs.getString("mother_name"));
                } 
                 con.close();
              }catch(Exception ex) {
 ...
 public static void main(String []args) { 
      Monitoring login=new Monitoring();
   } 
 }
